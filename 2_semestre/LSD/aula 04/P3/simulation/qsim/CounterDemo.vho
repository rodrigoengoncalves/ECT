...
-- Equation(s):
-- \s_count~3_combout\ = (\enable~input_o\ & ((\load~input_o\ & (\dataIn[0]~input_o\)) # (!\load~input_o\ & ((!s_count(0))))))
...
-- Equation(s):
-- \s_count~4_combout\ = (!\reset~input_o\ & ((\s_count~3_combout\) # ((s_count(0) & !\enable~input_o\))))
...
-- Equation(s):
-- \s_count~9_combout\ = (\enable~input_o\) # (\reset~input_o\)
