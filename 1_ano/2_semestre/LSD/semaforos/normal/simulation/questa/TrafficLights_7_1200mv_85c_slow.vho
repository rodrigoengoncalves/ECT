...
SIGNAL \main_fsm|Selector4~3_combout\ : std_logic;
SIGNAL \main_fsm|Selector4~2_combout\ : std_logic;
...
PORT MAP (
	datac => \clk_div_1hz|Equal0~11_combout\,
	datad => \clk_div_1hz|Add0~24_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \clk_div_1hz|Add0~28_combout\,
	datac => \clk_div_1hz|Equal0~11_combout\,
...
-- Equation(s):
-- \clk_div_1hz|Equal0~2_combout\ = (\clk_div_1hz|s_divCounter\(12) & (\clk_div_1hz|s_divCounter\(14) & (\clk_div_1hz|s_divCounter\(19) & \clk_div_1hz|s_divCounter\(13))))
...
-- pragma translate_on
PORT MAP (
	dataa => \clk_div_1hz|Add0~40_combout\,
	datac => \clk_div_1hz|Equal0~11_combout\,
...
-- Equation(s):
-- \clk_div_1hz|Equal0~5_combout\ = (\clk_div_1hz|s_divCounter\(2) & (\clk_div_1hz|s_divCounter\(4) & (\clk_div_1hz|s_divCounter\(5) & \clk_div_1hz|s_divCounter\(3))))
...
-- Equation(s):
-- \clk_div_1hz|Equal0~11_combout\ = (\clk_div_1hz|Equal0~9_combout\ & (\clk_div_1hz|Equal0~10_combout\ & (\clk_div_1hz|Equal0~4_combout\ & \clk_div_1hz|Equal0~5_combout\)))
...
-- Equation(s):
-- \clk_div_1hz|Equal0~7_combout\ = (!\clk_div_1hz|s_divCounter\(18) & (!\clk_div_1hz|s_divCounter\(24) & (\clk_div_1hz|s_divCounter\(25) & \clk_div_1hz|s_divCounter\(23))))
...
-- Equation(s):
-- \clk_div_1hz|clkOut~2_combout\ = (\clk_div_1hz|clkOut~1_combout\ & (!\clk_div_1hz|s_divCounter\(6) & \clk_div_1hz|clkOut~0_combout\))
...
-- Equation(s):
-- \main_fsm|Selector7~0_combout\ = (\timer_fsm|s_cntZero~q\ & (\main_fsm|s_currentState.TGreen1~q\)) # (!\timer_fsm|s_cntZero~q\ & ((\main_fsm|s_currentState.TYellow1~q\) # ((\main_fsm|s_currentState.TGreen1~q\ & \SW[0]~input_o\))))
...
-- Equation(s):
-- \main_fsm|sync_proc~9_combout\ = (\main_fsm|s_currentState.TYellow1~q\ & (((!\main_fsm|s_currentState.TGreen1~q\ & \timer_fsm|s_cntZero~q\)))) # (!\main_fsm|s_currentState.TYellow1~q\ & (\main_fsm|s_currentState.TGreen1~q\ & ((\SW[0]~input_o\) # 
...
-- Equation(s):
-- \main_fsm|s_stateChanged~2_combout\ = (\main_fsm|sync_proc~9_combout\) # ((\timer_fsm|s_cntZero~q\ & (\main_fsm|WideOr7~0_combout\ $ (!\main_fsm|s_currentState.TRed1~q\))))
...
-- Equation(s):
-- \main_fsm|s_stateChanged~0_combout\ = (\main_fsm|s_currentState.TGreen2~q\ & ((\main_fsm|s_currentState.TIntermit~q\ $ (\main_fsm|Selector4~2_combout\)) # (!\main_fsm|Selector11~0_combout\))) # (!\main_fsm|s_currentState.TGreen2~q\ & 
-- ((\main_fsm|Selector11~0_combout\) # (\main_fsm|s_currentState.TIntermit~q\ $ (\main_fsm|Selector4~2_combout\))))
...
PORT MAP (
	...
	datac => \main_fsm|Selector4~2_combout\,
...
-- Equation(s):
-- \main_fsm|s_stateChanged~5_combout\ = (!\main_fsm|s_stateChanged~4_combout\ & (!\main_fsm|s_stateChanged~2_combout\ & (!\main_fsm|s_stateChanged~0_combout\ & !\main_fsm|s_stateChanged~1_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \main_fsm|s_stateChanged~4_combout\,
...
-- Equation(s):
-- \timer_fsm|Add1~2_combout\ = (!\main_fsm|s_stateChanged~q\ & (!\main_fsm|s_currentState.TYellowBoth~q\ & (!\main_fsm|s_currentState.TYellow1~q\ & !\main_fsm|s_currentState.TYellow2~q\)))
...
-- Equation(s):
-- \timer_fsm|s_cntZero~1_combout\ = (\timer_fsm|s_counter\(5) & (\timer_fsm|s_counter\(4) & (\timer_fsm|s_counter\(3) & \timer_fsm|s_counter\(6))))
...
-- Equation(s):
-- \timer_fsm|Add0~0_combout\ = (\main_fsm|s_currentState.TYellow2~q\ & ((\main_fsm|s_currentState.TGreen2~q\) # ((!\main_fsm|WideOr1~0_combout\)))) # (!\main_fsm|s_currentState.TYellow2~q\ & (\main_fsm|WideOr7~0_combout\ $ 
-- (((\main_fsm|s_currentState.TGreen2~q\) # (!\main_fsm|WideOr1~0_combout\)))))
...
-- Equation(s):
-- \timer_fsm|Add1~20_combout\ = \timer_fsm|s_counter\(7) $ (\timer_fsm|Add1~19\)
...
-- Equation(s):
-- \main_fsm|Selector10~0_combout\ = (\timer_fsm|s_cntZero~q\ & (((\main_fsm|s_currentState.TGreen2~q\)))) # (!\timer_fsm|s_cntZero~q\ & ((\main_fsm|s_currentState.TYellow2~q\) # ((\SW[0]~input_o\ & \main_fsm|s_currentState.TGreen2~q\))))
...
\main_fsm|Selector4~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \main_fsm|Selector4~3_combout\ = (\SW[0]~input_o\ & ((\main_fsm|s_currentState.TRed1~q\) # ((\main_fsm|s_currentState.TRed2~q\) # (\main_fsm|s_currentState.TIntermit~q\))))
...
PORT MAP (
	...
	combout => \main_fsm|Selector4~3_combout\);

-- Location: LCCOMB_X82_Y66_N8
\main_fsm|Selector4~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \main_fsm|Selector4~2_combout\ = ((\timer_fsm|s_cntZero~q\ & (\main_fsm|Selector4~3_combout\)) # (!\timer_fsm|s_cntZero~q\ & ((\main_fsm|s_currentState.TIntermit~q\)))) # (!\main_fsm|s_currentState.TInit~q\)
...
-- pragma translate_on
PORT MAP (
	dataa => \main_fsm|Selector4~3_combout\,
	datab => \main_fsm|s_currentState.TIntermit~q\,
	datac => \main_fsm|s_currentState.TInit~q\,
	datad => \timer_fsm|s_cntZero~q\,
	combout => \main_fsm|Selector4~2_combout\);

-- Location: LCCOMB_X81_Y66_N4
\main_fsm|s_currentState~14\ : cycloneive_lcell_comb
-- Equation(s):
-- \main_fsm|s_currentState~14_combout\ = (\KEY[0]~input_o\ & \main_fsm|Selector4~2_combout\)
...
-- Equation(s):
-- \main_fsm|WideOr7~0_combout\ = (!\main_fsm|s_currentState.TYellowBoth~q\ & !\main_fsm|s_currentState.TYellow1~q\)
...
-- pragma translate_on
PORT MAP (
	datac => \main_fsm|s_currentState.TYellowBoth~q\,
...
-- Equation(s):
-- \main_fsm|WideOr3~0_combout\ = (\main_fsm|s_currentState.TGreen1~q\) # ((\main_fsm|s_currentState.TRed2~q\) # ((\main_fsm|s_currentState.TRed1~q\) # (\main_fsm|s_currentState.TYellow1~q\)))
...
-- Equation(s):
-- \main_fsm|WideOr1~combout\ = (\main_fsm|s_currentState.TRed1~q\) # ((\main_fsm|s_currentState.TYellow2~q\) # ((\main_fsm|s_currentState.TGreen2~q\) # (\main_fsm|s_currentState.TRed2~q\)))
...
-- Equation(s):
-- \LEDR~1_combout\ = (\main_fsm|s_currentState.TIntermit~q\ & (\clk_div_1hz|clkOut~q\)) # (!\main_fsm|s_currentState.TIntermit~q\ & (((\main_fsm|s_currentState.TYellowBoth~q\) # (\main_fsm|s_currentState.TYellow1~q\))))
