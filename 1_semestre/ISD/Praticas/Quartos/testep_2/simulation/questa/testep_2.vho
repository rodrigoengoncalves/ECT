...
ARCHITECTURE structure OF testep_2 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \inst6~0_combout\ = (\x~input_o\ & ((\inst7~q\) # (\inst9~q\)))
...
-- Equation(s):
-- \inst8~combout\ = (\x~input_o\ & !\inst7~q\)
...
-- Equation(s):
-- \inst11~0_combout\ = (!\x~input_o\ & ((\inst9~q\) # (\inst7~q\)))
